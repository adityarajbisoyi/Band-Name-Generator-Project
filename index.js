...
let greet = { data: "Welcome to bandname-generator" };




function generateBandName() {
  let c1 = Math.floor(Math.random() * adj.length);
  let c2 = Math.floor(Math.random() * noun.length);
  return adj[c1] + "-" + noun[c2];
}



app.get("/", (req, res) => {
  res.render("index.ejs", greet);
});

app.post("/submit", (req, res) => {

  let bandName = generateBandName();
  let band = { data: bandName };
  res.render("index.ejs", band);
